...
def drop_trials_pool_derivative_schema(stop_drop_after_schema=None):
    drop_map = {
        "jguidera_glm": drop_jguidera_el_net,
...
def drop_position_schema(stop_drop_after_schema=None):
    drop_map = {
        "jguidera_head_speed": drop_jguidera_head_speed,
...
def drop_event_schema(stop_drop_after_schema=None):
    drop_map = {
        "jguidera_dio_trials": drop_jguidera_dio_trials,
...
def drop_time_bins_schema(stop_drop_after_schema=None):
    drop_map = {
        "jguidera_warped_axis_bins": drop_jguidera_warped_axis_bins,
...
def drop_spikes_schema(stop_drop_after_schema=None):
    drop_map = {
        "jguidera_lfp": drop_jguidera_lfp,  # depends on jguidera_brain_region
...
def drop_firing_rate_map_schema(stop_drop_after_schema=None):
    drop_map = {
        "jguidera_well_arrival_departure_firing_rate_map": drop_jguidera_well_arrival_departure_firing_rate_map,
...
def drop_metadata_schema(stop_drop_after_schema=None):
    drop_map = {
        "jguidera_maze": drop_jguidera_maze,
...
def drop_decoding_schema(stop_drop_after_schema=None):
    drop_map = {
        "jguidera_edeno_decoder_helpers": drop_jguidera_edeno_decoder_helpers
    }
    return stoppable_function_loop(drop_map, stop_drop_after_schema)
...
def drop_firing_rate_vector_schema(stop_drop_after_schema=None):
    drop_map = {
        "jguidera_firing_rate_difference_vector_similarity_ave": drop_jguidera_firing_rate_difference_vector_similarity_ave,
