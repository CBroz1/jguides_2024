...
from jguides_2024.firing_rate_vector.jguidera_firing_rate_vector_embedding import FRVecEmb
...
from jguides_2024.spike_sorting_curation.jguidera_spikesorting import SpikeSortingRecordingCohortParams
