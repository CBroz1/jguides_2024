...
from jguides_2024.time_and_trials.jguidera_res_set import ResSetParams, reset
...
class ResEpochSpikeTimes(ComputedBase):
    ...
    def make(self, key):
        ...
        spike_times = [
            reset().apply_restriction(key, time_bin_centers=x)[0]
        ...
        key["valid_time_intervals"] = (reset & key).fetch1(
