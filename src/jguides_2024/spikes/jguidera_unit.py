            ...
            if len(epochs) == 1:
                ...
                if len(table_subset) > 0:
                    ...
                    if epoch in (
                        ...
                        valid_epochs = all(
                            [x in curation_epochs for x in epochs]
                        )
...
class BrainRegionUnitsParams(SecKeyParamsBase):
    ...
    def _check_params(cls, key):
        ...
        check_membership(
            [key["unit_subset_type"]],
            cls._valid_unit_subset_type(),
            "passed unit subset type",
    ...
    def _make_param_name(
        ...
        check_membership(
            ...
            self._valid_unit_subset_type(),
            "list with passed unit subset type",
            "available unit subset types",
        )
