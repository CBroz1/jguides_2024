...
@schema
class DecodeMultiCovFRVecParams(
    dj.Manual
):  # use when initially generating table; if not cannot update table later
    ...
    def insert_defaults(self, **kwargs):
        ...
        decode_multi_cov_fr_vec_param_name = (
        ...
        decode_multi_cov_fr_vec_params = {
            ...
            "multi_cov_fr_vec_param_name": "correct_incorrect_stay_trials",
            "cross_validation_method": "loocv",
        }
        self.insert1(
            {
                "decode_multi_cov_fr_vec_param_name": decode_multi_cov_fr_vec_param_name,
                "decode_multi_cov_fr_vec_params": decode_multi_cov_fr_vec_params,
            },
